import { tools } from "../assets/index"
...
const Toolbar = ({
    ...
    return (
        <div className="fixed top-[900px] left-0 w-full bg-secondary p-3 z-20 shadow-lg">
            <div className=" flex flex-row p-5 justify-between w-full gap-5 md:gap-8">
